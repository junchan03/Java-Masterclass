...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        BasicBurger basicBurger = new BasicBurger("Whole Wheat Bread", "Beef");
        basicBurger.chooseIngredients(true, false, true, true, false, false, true);
        System.out.println("");
        DeluxBurger deluxBurger = new DeluxBurger("Whole grain", "Chicken");
        deluxBurger.chooseIngredients(true, true, true, true, false, true, true);
        System.out.println("");
        HealthyBurger healthyBurger = new HealthyBurger();
        healthyBurger.chooseIngredients(true, true, true, false, true, true, true);
    }
